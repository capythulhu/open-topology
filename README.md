...
Early, but it runs. Animated noise terrain in 3D with six effects, including a shallow-water simulation and two that draw their own geometry. Sensor input, projector output, and calibration are not built yet.
